...
public class SegmentDTO {
    ...
    public Duration getLayoverTime() { return layoverTime; }
    ...
    public void setAmenities(List<Amenities> amenities) { this.amenities = amenities; }
    public void setLayoverTime(Duration layoverTime) { this.layoverTime = layoverTime; }
