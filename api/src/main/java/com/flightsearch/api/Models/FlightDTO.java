...
public class FlightDTO {
    ...
    public List<StopDetails> getStops() { return stops; }
    public double getPrice() { return price; }
    public String getCurrency() { return currency; }
    public List<Double> getPricePerTraveler() { return pricePerTraveler; }
    public String getReturnDepartureIata() { return returnDepartureIata; }
    public String getReturnDepartureName() { return returnDepartureName; }
    public String getReturnArrivalIata() { return returnArrivalIata; }
    public String getReturnArrivalName() { return returnArrivalName; }
    public LocalDateTime getReturnDepartureTime() { return returnDepartureTime; }
    public LocalDateTime getReturnArrivalTime() { return returnArrivalTime; }
    ...
    public void setStops(List<StopDetails> stops) { this.stops = stops; }
    public void setPrice(double price) { this.price = price; }
    public void setCurrency(String currency) { this.currency = currency; }
    public void setPricePerTraveler(List<Double> pricePerTraveler) { this.pricePerTraveler = pricePerTraveler; }
    public void setReturnDepartureIata(String returnDepartureIata) { this.returnDepartureIata = returnDepartureIata; }
    public void setReturnDepartureName(String returnDepartureName) { this.returnDepartureName = returnDepartureName; }
    public void setReturnArrivalIata(String returnArrivalIata) { this.returnArrivalIata = returnArrivalIata; }
    public void setReturnArrivalName(String returnArrivalName) { this.returnArrivalName = returnArrivalName; }
    public void setReturnDepartureTime(LocalDateTime returnDepartureTime) { this.returnDepartureTime = returnDepartureTime; }
    public void setReturnArrivalTime(LocalDateTime returnArrivalTime) { this.returnArrivalTime = returnArrivalTime; }
